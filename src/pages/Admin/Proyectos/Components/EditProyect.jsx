...
function EditProyect({data, children }) {
    console.log(data)
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(`https://localhost:8080/proyecto/${data.id_proyecto}`, {
                method: 'PUT',
                headers: {
    ...
    return (
        ...
        <div className="fixed inset-0 bg-gray-800 bg-opacity-50 flex items-center justify-center">
            ...
            <form onSubmit={handleSubmit} className="max-w-lg mx-auto mt-8 bg-white p-10">
                <p className=' text-4xl mb-2'>Editar Proyecto</p>
